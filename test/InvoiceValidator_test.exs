defmodule InvoiceValidatorTest do
  ...
  data = [
    ...
    # para que salga ok, se toma en cuenta el horario de verano 
    {"72 hrs atras fail", "America/Cancun", ~N[2022-03-20 16:06:31], :error},
    {"72 hrs atras success", "America/Tijuana", ~N[2022-03-20 14:06:35], :ok},
    ...
    # para que salga error, se toma en cuenta el horario de verano
    {"5 mns adelante success", "America/Cancun", ~N[2022-03-23 16:11:35], :ok}, 
    {"5 mns adelante fail", "America/Tijuana", ~N[2022-03-23 14:11:36], :error},
